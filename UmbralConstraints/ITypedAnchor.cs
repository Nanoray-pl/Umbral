...
public interface ITypedAnchor<TBaseView, TViewSystem, TVector, TVectorComponent, TPriority, TMultiplier> : IAnchor<TBaseView, TViewSystem, TVector, TVectorComponent, TPriority, TMultiplier>
...
#endif
{
    ITypedAnchor<TBaseView, TViewSystem, TVector, TVectorComponent, TPriority, TMultiplier> GetSameAnchor(TBaseView view);
}
