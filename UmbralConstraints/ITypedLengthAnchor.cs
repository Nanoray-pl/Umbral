...
public interface ITypedLengthAnchor<TBaseView, TViewSystem, TVector, TVectorComponent, TPriority, TMultiplier> : ITypedAnchor<TBaseView, TViewSystem, TVector, TVectorComponent, TPriority, TMultiplier>
...
#endif
{
    new ITypedLengthAnchor<TBaseView, TViewSystem, TVector, TVectorComponent, TPriority, TMultiplier> GetSameAnchor(TBaseView view);
}
