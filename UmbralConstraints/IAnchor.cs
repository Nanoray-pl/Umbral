...
public interface IAnchor<TBaseView, TViewSystem, TVector, TVectorComponent, TPriority, TMultiplier>
...
#endif
{
    ...
    bool IsCompatibleWithAnchor(IAnchor<TBaseView, TViewSystem, TVector, TVectorComponent, TPriority, TMultiplier> other);
}
